...
<!-- Mirrored from demo.webtend.net/html/lezar/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 May 2023 16:36:01 GMT -->
<head>
    <!--====== Required meta tags ======-->
    <meta charset="utf-8" />
    ...
    <!--====== Title ======-->
    <title>Jody's Threading n Beauty Care</title>
    <!--====== Favicon Icon ======-->
...
<body>
    <div class="page-wrapper">
           ...
           <div class="header-top-wrap bg-black text-white py-10">
               <div class="container">
                   <div class="header-top">
                        <ul>
                            <li><i class="far fa-clock"></i> <span>Opening hours :</span> Manday - friday, 08am - 05pm</li>
                            <li><i class="flaticon-locations"></i> <span>Address :</span> 55 Main Street, 2nd Block, New York</li>
                        </ul>
                   </div>
               </div>
           </div>
                ...
                <div class="container-fluid clearfix">
                    ...
                    <div class="header-inner d-flex align-items-center bg-white">
                        <div class="logo-outer">
                            <div class="logo"><a href="index.html"><img src="assets/images/logos/color-logo.png" alt="Logo" title="Logo"></a></div>
                        </div>
                            ...
                            <nav class="main-menu navbar-expand-lg">
                                <div class="navbar-header">
                                   ...
                                   <div class="mobile-logo p-15 m-auto">
                                       <a href="index.html">
                                            <img src="assets/images/logos/color-logo.png" alt="Logo" title="Logo">
                                       </a>
                                   </div>
                                </div>
        ...
        <section class="hidden-bar">
            <div class="inner-box text-center">
                ...
                <div class="appointment-form">
                    <form method="post" action="https://demo.webtend.net/html/lezar/contact.html">
        ...
        <!-- Page Banner Start -->
        <section class="page-banner text-white py-165 rpy-130" style="background-image: url(assets/images/banners/page-banner.jpg);">
            <div class="container">
        ...
        <!-- About Section Start -->
        <section class="about-page-section rel z-2 pt-140 rpt-90">
            <div class="container">
                <div class="row mb-55">
                    <div class="col-lg-5">
                    ...
                    <div class="col-lg-7">
                        <div class="about-page-right-text wow fadeInRight delay-0-2s">
                            <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium totam rem aperia eaque ipsa quae abillo inventore veritatis quasi architecto beatae vitae dicta sunt explicabo. Nemo enim quia voluptas sit aspernatur aut odit aut fugit sed consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt porro quisquam</p>
                            <p>Nemo enim quia voluptas sit aspernatur aut odit aut fugit sed consequuntur magni dolores ratione voluptatem sequi nesciunt quisquam</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="about-page-left mb-30 wow fadeInUp delay-0-2s">
                            <img src="assets/images/about/about-page-left.jpg" alt="About">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="about-page-right-video mb-30 wow fadeInUp delay-0-4s">
                            <img src="assets/images/about/about-page-right.jpg" alt="About">
        ...
        <section class="about-page pb-120 pt-110">
            <div class="container">
            ...
            <div class="category-section">
                <div class="category-item style-two wow fadeInUp delay-0-2s">
                ...
                <div class="category-item style-two wow fadeInUp delay-0-4s">
                ...
                <div class="category-item style-two wow fadeInUp delay-0-6s">
                ...
                <div class="category-item style-two wow fadeInUp delay-0-8s">
                ...
                <div class="category-item style-two wow fadeInUp delay-1-0s">
        ...
        <div class="feedback-section mb-150 rmb-100">
            <div class="container">
                <div class="about-page-feedback rel z-1 bg-butter">
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="feedback-left-image bgs-cover h-100 wow fadeInLeft delay-0-2s" style="background-image: url(assets/images/testimonials/about-page-feedback.jpg);"></div>
                        </div>
                        <div class="col-xl-6">
                    ...
                    <div class="feedback-leaf">
                        <img src="assets/images/shapes/about-page-leaf.png" alt="Feedback Leaf">
                    </div>
                </div>
            </div>
        </div>
       ...
       <!-- Instagram Section Start -->
        <div class="instagram-section mb-120 rmb-70">
            <div class="instagram-item wow fadeInUp delay-0-2s">
                <img src="assets/images/instagram/instagram-1.jpg" alt="Instagram">
                <a href="assets/images/instagram/instagram-1.jpg"><i class="fab fa-instagram"></i></a>
            </div>
            <div class="instagram-item wow fadeInUp delay-0-4s">
                <img src="assets/images/instagram/instagram-2.jpg" alt="Instagram">
                <a href="assets/images/instagram/instagram-2.jpg"><i class="fab fa-instagram"></i></a>
            </div>
            <div class="instagram-item wow fadeInUp delay-0-6s">
                <img src="assets/images/instagram/instagram-3.jpg" alt="Instagram">
                <a href="assets/images/instagram/instagram-3.jpg"><i class="fab fa-instagram"></i></a>
            </div>
            <div class="instagram-item wow fadeInUp delay-0-8s">
                <img src="assets/images/instagram/instagram-4.jpg" alt="Instagram">
                <a href="assets/images/instagram/instagram-4.jpg"><i class="fab fa-instagram"></i></a>
            </div>
            <div class="instagram-item wow fadeInUp delay-1-0s">
                <img src="assets/images/instagram/instagram-5.jpg" alt="Instagram">
                <a href="assets/images/instagram/instagram-5.jpg"><i class="fab fa-instagram"></i></a>
            </div>
        </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="footer-widget menu-widget">
                            ...
                            <ul>
                                ...
                                <li><a href="#">Autumn vibes</a></li>
                                <li><a href="#">Makeup</a></li>
                                <li><a href="#">Body Treatments</a></li>
                                <li><a href="#">Spa & Foot Massage</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <div class="footer-widget contact-widget">
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="info-content">
                                        <h5>Email</h5>
                                        <a href="https://demo.webtend.net/cdn-cgi/l/email-protection#b3c0c6c3c3dcc1c7f3d4ded2dadf9dd0dcde"><span class="__cf_email__" data-cfemail="8af9fffafae5f8fecaede7ebe3e6a4e9e5e7">[email&#160;protected]</span></a>
                                    </div>
                                </li>
                            </ul>
                        </div>
...
<!-- Mirrored from demo.webtend.net/html/lezar/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 May 2023 16:36:24 GMT -->
</html>